g_yijiEvents = ["嫁娶","入宅","动土","开市","出行","挂匾","安门","安床","拆卸","买车","造屋","置产","交易","理发","开光","祈福","订盟","纳采","安葬","扫舍","祭祀","会亲友","裁衣","合帐","挽面","纳婿","斋醮","安香","求嗣","塑绘","谢土","解除","造庙","造桥","修造","破土","作厕","移徙","筑堤","出火","作灶","开池","伐木","冠笄","问名","开容","启攒","起基","修坟","立碑","入殓","移柩","成服","除服","纳财","立券","作染","鼓铸","酝酿","造船","分居","入学","沐浴","赴任","求医","捕捉","割蜜","取渔","栽种","结网","牧养","纳畜","破屋","坏垣","竖柱","上梁","开渠","掘井","扫舍","探病","酬神","雕刻","见贵","开仓","习艺","雇庸","合脊","架马","定磉","作梁","补垣","塞穴","针灸","经络","治病","词讼","畋猎","造仓","乘船","放水","渡水","修门","进人口","安碓硙","开生坟","合寿木","教牛马","出货财","开柱眼","安机械","造车器","修饰垣墙","平治道涂","整手足甲","造畜椆栖"];
